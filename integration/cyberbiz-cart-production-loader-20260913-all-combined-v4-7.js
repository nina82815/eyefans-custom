/*
 * eYeFANS CYBERBIZ integration — ALL COMBINED PRODUCTS CANDIDATE V4.7.
 *
 * UNPUBLISHED PRODUCTION CANDIDATE V4.7 / DO NOT INSTALL ON A PUBLISHED THEME.
 *
 ...
 */
(function eyefansCyberbizCartAllCombinedProductionCandidateV4_7Loader() {
  "use strict";
  ...
  async function resolveSessionCartToken(signal, allowEmptyCart = false) {
    ...
    try {
      ...
      if (typeof response.url !== "string") throw new Error("CART_IDENTITY_UNVERIFIED");
