/*
 * eYeFANS CYBERBIZ integration — ALL COMBINED PRODUCTS CANDIDATE V4.
 *
 * UNPUBLISHED PRODUCTION CANDIDATE V4 / DO NOT INSTALL ON A PUBLISHED THEME.
 *
 ...
 */
(function eyefansCyberbizCartAllCombinedProductionCandidateV4Loader() {
  "use strict";
  ...
  const developmentRuntime = (() => {
    try {
      ...
      return loaderUrl.searchParams.get("eyefans_all_combined_development") === "1";
    } catch (error) {
      return false;
    }
  })();
