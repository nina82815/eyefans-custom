/*
 * eYeFANS CYBERBIZ integration — ALL COMBINED PRODUCTS CANDIDATE V4.3.
 *
 * UNPUBLISHED PRODUCTION CANDIDATE V4.3 / DO NOT INSTALL ON A PUBLISHED THEME.
 *
 ...
 */
(function eyefansCyberbizCartAllCombinedProductionCandidateV4_3Loader() {
  "use strict";
  ...
  function startProductBridge(context) {
    ...
    function enable() {
      ...
      if (iframeUrl.searchParams.get("cart") !== "1" || previewNeedsUpdate) {
