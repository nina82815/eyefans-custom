/*
 * eYeFANS CYBERBIZ integration — ALL COMBINED PRODUCTS CANDIDATE V4.8.
 *
 * UNPUBLISHED PRODUCTION CANDIDATE V4.8 / DO NOT INSTALL ON A PUBLISHED THEME.
 *
 ...
 */
(function eyefansCyberbizCartAllCombinedProductionCandidateV4_8Loader() {
  "use strict";
  ...
  async function resolveSessionCartToken(signal, allowEmptyCart = false) {
    ...
    try {
      ...
      const emptyHomeDestination = destination.pathname === "/"
        && destination.search === ""
        && destination.hash === "";
      if (allowEmptyCart && (/^\/cart\/?$/.test(destination.pathname) || emptyHomeDestination)) return null;
